...
# Loop over all subdirectories in the mask images dataset and load the images and labels
for directory in os.listdir(MASK_DATASET):
    label = os.path.join(MASK_DATASET, directory)
...
# Saving model
print("Saving training model for mask and no mask recognition...")
model.save("MaskRecognition.h5")
